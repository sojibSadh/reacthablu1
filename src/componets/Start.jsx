...
function Start() {
    return (
        <section className='bg-[#002228]'>
            <div className='max-w-[1200px] mx-auto md:py-24 py-8 space-y-6 text-center'>
                ...
                <button  className='bg-cyan font-medium text-foreground py-4 px-5  max-sm:py-2 rounded-full hover:bg-white transition hover:text-cyan max-sm:text-[14px]'>
